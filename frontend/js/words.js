document.addEventListener("DOMContentLoaded", () => {
    ...
    createModuleBtn.onclick = async () => {
        ...
        const res = await fetch(`${BASE_URL}/modules/?name=${name}&folder_id=${currentFolderId}`, {
            method: "POST",
            headers: {
                Authorization: `Bearer ${token}`
            }
        ...
        const createCardElement = modulesContainer.querySelector(".folder-create-card");
        modulesContainer.insertBefore(card, createCardElement);
    };
